...
Bamezai et al. (2026), [Table 7, excerpt](https://www.mrsharan.com/papers/political-selection.pdf#page=44). Columns 1–3 measure standardized schooling; column 3 substitutes the husband's schooling.[^bamezai]
...
The [statewide Bihar 2021 release](https://github.com/in-rolls/local_elections_bihar#2021-and-the-current-portal) contains 66,430 candidacies and 8,050 flagged mukhiya winners across 38 districts. Its [coverage table](https://github.com/in-rolls/local_elections_bihar/blob/master/data/release/2021/coverage.parquet) retains all 8,067 enumerated panchayats, including eight without a winner flag and nine with empty results. [Validation and source provenance](https://github.com/in-rolls/local_elections_bihar/blob/master/data/release/2021/MANIFEST.json) accompany the Parquet release. The data flow is `local_elections_bihar` → `local_reservations` → this analysis.

The current SEC reservation and winner feeds agree on women's reservation for all 8,067 mukhiya seats. Their total of 3,583 women-reserved seats also matches the [SEC's 2021 report](https://sec.bihar.gov.in/PanchayatRpt/ch1.aspx); caste totals differ by one seat. Among 35 winners with conflicting gender fields, both feeds link to the same nomination document. [Source checks and flagged records](https://github.com/in-rolls/local_elections_bihar/tree/d22f05452e1ec15079249ee5f5e04953efae8d74/data/fin/reservation_check_2021) preserve these distinctions. The undated reservation feed has not been adopted as the 2021 treatment variable; agreement between current feeds does not verify every historical assignment.

Nomination documents have been inspected for all 64 Arwal winners: degree status is classified for 57 and unresolved for seven. The [data](https://github.com/in-rolls/local_elections_bihar/blob/master/data/fin/2021/education.parquet), [transcriptions](https://github.com/in-rolls/local_elections_bihar/blob/master/data/fin/2021/education_review.csv), and [source pages](https://github.com/in-rolls/local_elections_bihar/tree/master/data/fin/2021/education_pages) retain reported qualifications, prior office, reservation text and document provenance. These are Codex visual transcriptions without independent second coding. Statewide affidavit work has stopped. Structured 2021 winner education has not been located; no 2021 reservation-effect estimate is reported here.
