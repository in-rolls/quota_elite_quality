...
The manuscript reviews the existing papers, including contrary findings and differences between absolute qualifications and selection relative to same-gender citizens. Each citation identifies the version and source table. [Historical descriptive tables](evidence/legacy_readme_tables.json) preserve the earlier README's candidate and municipal tabulations.
